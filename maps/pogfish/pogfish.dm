	...
	#include "torch/torch_ranks_boh.dm"
	...
	#include "pogfish1_hangar.dmm"
	#include "pogfish2_deck.dmm"
	#include "pogfish3_bridge.dmm"
	...
	#warn A map has already been included, ignoring Pogfish
